    ...
    <div class="text-left col-8 col-xl-6 block-center">
      <div class="input-group-m">
        ...
        <input type="text" class="form-control" id="name" name="name"
               value="<?= FormHelper::getValue('name', 'signup_form') ?>" />
      </div>
      <div class="input-group-m">
        <label for="lastname">Фамилия</label>
        <input type="text" class="form-control" id="lastname" name="lastname"
               value="<?= FormHelper::getValue('lastname', 'signup_form') ?>" />
      </div>
      <div class="input-group-m">
        <label for="birthdate">Дата рождения</label>
        <input type="date" class="form-control" id="birthdate" name="birthdate"
               value="<?= FormHelper::getValue('birthdate', 'signup_form') ?>" />
      </div>
      <div class="input-group-m">
        <label for="phone_number">Номер телефона</label>
        <input type="text" class="form-control" id="phone_number" name="phone_number"
               value="<?= FormHelper::getValue('phone_number', 'signup_form') ?>" />
      </div>
      <div class="input-group-m">
        <label for="login">Логин</label>
        <input type="text" class="form-control" id="login" name="login"
               value="<?= FormHelper::getValue('login', 'signup_form') ?>" />
      </div>
      <div class="input-group-m">
